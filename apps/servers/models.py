...
class NetworkDevice(models.Model):
    ...
    mac = models.CharField('网卡mac地址', max_length=32, help_text='网卡mac地址')
...
class IP(models.Model):
    """主机ip地址."""
    ip_addr = models.CharField('ip地址', max_length=20, db_index=True, help_text='ip地址')
    netmask = models.CharField('子网掩码', max_length=20, help_text='子网掩码')
